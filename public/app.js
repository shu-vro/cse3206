...
class App {
    constructor() {
        ...
        this.transcript = new Transcript(document.getElementById("transcript"), (i) =>
            this.player.seek(this.transcript.startTime(i))
        );
    ...
    async generate() {
        ...
        try {
            const { audio, words } = await this.client.synthesize(text, this.voiceEl.value);
...
if (typeof module !== "undefined") module.exports = { TTSClient, Transcript, Player, App };
